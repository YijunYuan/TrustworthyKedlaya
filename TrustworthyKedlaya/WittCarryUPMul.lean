...
public import TrustworthyKedlaya.WittCarryUP
public import TrustworthyKedlaya.MulCombine
...
combinations in the sense of `TrustworthyKedlaya.MulCombine`, hence UP — with
...
(`TrustworthyKedlaya.EngineTruncUP`) applies.
