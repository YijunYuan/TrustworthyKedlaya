...
public import TrustworthyKedlaya.Kedlaya.Truncation
...
Truncation at the point `0` preserves UP (`TrustworthyKedlaya.Kedlaya.Truncation`); this
...
(`TrustworthyKedlaya.Kedlaya.Multiplicative`), and restriction windows translate along
the shift, so
